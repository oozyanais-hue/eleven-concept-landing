...
export function HeroSection() {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 text-center max-w-4xl mx-auto px-6 pt-24 animate-fade-in-up">
        <div className="mb-4 flex flex-col items-center">
          <BrandLogo size="lg" showText={false} />
        </div>

        <h1 className="font-heading text-4xl md:text-6xl lg:text-7xl font-light leading-tight mb-5 text-cream">
          Elevamos o conceito do seu ambiente
          <br />
          <span className="gold-text-gradient font-medium italic">ao nível 11</span>
          <span className="block text-2xl md:text-3xl lg:text-4xl text-muted-foreground font-light mt-3 not-italic">
            do projeto à entrega final
          </span>
        </h1>

        <p className="text-lg md:text-xl text-cream/80 max-w-2xl mx-auto mb-8 font-body font-light leading-relaxed">
